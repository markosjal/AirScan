...
<body>
AirScan Version 10.0

New in Version 10
Airscan now has the ability to make Single and Multi Page PDF files. This is done from the scan interface. Select a  new PDF name to start scanning. 
If you choose an existing PDF name you will add to that project however it is best to first load the project to ensure you scan at the same resolution 
as other files in the same project. 

Scan all PDFs at the same resolution for best results. If you have mixed page sizes you can try auto page Size auto but there is no guartantee 
as to results. See the samples here 
<a href='TestPDFAuto.pdf'> This file uses Auto Page Size<a>




This readme file is now basic HTML for viewing in Web browser





New in version 9, PAM authentication
...
you will need to install pwauth for PAM
...
This keeps uencrypted passwords out of the web server's direct path. 
