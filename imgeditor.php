    ...
    <body>
        <div class="body-container">
            <div class="tui-image-editor-controls">
                <div class="header">
                    <img class="logo" src="images/AirScan.png">
                    <span class="name">AirScan Image Editor</span>
                    <ul class="menu">
        ...
        <script type="text/javascript" src="javascript/colorpicker.min.js"></script>
        <script type="text/javascript" src="javascript/tui-image-editor.js"></script>
        <script src="javascript/service-basic.js"></script>
<script>
