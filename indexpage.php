...
<nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand page-scroll" href="#page-top">AirScan</a></div>
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        ...
        <?php // <li><a class="page-scroll" href="#contact">Contact</a></li> ?>
      </ul>
    </div>
  </div>
</nav>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 col-md-offset-2">
        <h2 class="section-heading"><?php echo $intheair;?></h2>
<?php echo $moreinfo;?>
    ...
    <div class="row">
      <div class="col-lg-12 text-center">
        <div class="section-heading">
          <h2><span style="color:#666; font-weight:bold"><?php echo $whatitdoes;?></span></h2>
          <p class="text-muted"><span style="color:#666; font-weight:bold"><?php echo $thisandmore;?></span></p>
          <hr>
        </div>
      </div>
    </div>
...
<table style="width: 100%"><tr style='background-color: #f5f5f5; width: 100%'><td style="text-align: center"><span style="color:#666; font-weight:bold"></span></td><td style="text-align: center"><span style="color:#666; font-weight:bold"><?php echo $price;?></span></td></tr>
<tr style='background-color: #f5f5f5; width: 100%'>
<td style="text-align: center"><a href="http://teknogeekz.com/downloads/AirScan7.0Free.zip"><span style="color:#666; font-weight:bold"><?php echo $startdownload;?></span></td>
