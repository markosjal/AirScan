...
$flopcmd = $imagemagicklocation.' -flop '.$previewimage.' '.$_SESSION['userpath'].$floppedfile;
	...
	if ($_SESSION['password']=='PAM')
	{	
	$chmod= 'chmod 777 '.$_SESSION['userpath'].$flippededfile;	
	}
	else 
	{	
	$chmod= '';	
...
if (!isset($_GET['degrees']))
{
	...
	echo '<center><p><span style="color:#666; font-weight:bold">'.$rotating.' '.$image.'</span></p>';
		...
		<input type="text" value="'.$basename.$flipname.'" style="width: 160px; height: 15px; color:#666; background-color: #DDD; font-weight:bold" name="newname"></td><td><span style="color:#666; font-weight:bold">.</span></td><td>';
...
<table border=0><tr>
<td>&nbsp;&nbsp;
<input type="radio" name="flip" value="flop" ?><span style="color:#666; font-weight:bold">'.$mirrortxt.'</span>
</td></tr><tr><td>&nbsp;&nbsp;
<input type="radio" name="flip" value="flip" ?><span style="color:#666; font-weight:bold">'.$flipvtxt.'</span>
</td></tr></table>
